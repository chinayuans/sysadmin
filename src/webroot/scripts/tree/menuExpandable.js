...
function initializeMenu(menuId, actuatorId) {
    ...
    actuator.parentNode.style.backgroundImage = "url(images/tree/plus.gif)";
    actuator.onclick = function() {
        var display = menu.style.display;
        this.parentNode.style.backgroundImage =
            (display == "block") ? "url(images/tree/plus.gif)" : "url(images/tree/minus.gif)";
...
function openMenu(menuId) {
    ...
    if (menu != null) {
        var display = menu.style.display;
        menu.parentNode.style.backgroundImage = "url(images/tree/minus.gif)";
        menu.style.display = (display == "block") ? "none" : "block";
    }
}
