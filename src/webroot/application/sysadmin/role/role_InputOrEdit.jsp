				...
				<tr>
					...
					<td background="images/tbl/m6.gif" align="center" valign="top">
							...
							<c:if test="${method=='saveOne' or method=='updateOne' or method=='updateSome'}">
							   <html:javascript formName="roleForm"/><!--修改之处-->
							</c:if>
							<html:errors/>
							...
							<html:form action="/role"  
							           ...
							           onsubmit="return validateroleForm(this);" >  <!--修改之处-->
							    ...
							    <table class="border">
							        <tr>
							            ...
							            <td>
							                <html:text property="role.description" styleClass="text" />
							            </td>
							            <td><bean:message key="role.comments" />:</td>
							            <td><html:text property="role.comments" styleClass="text"/></td>
							        </tr>
