...
public class CheckBoxOptionsTag extends TagSupport {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(CheckBoxOptionsTag.class);
	...
	public int doStartTag() throws JspException {
        ...
        for (Iterator i = list.iterator(); i.hasNext();) {
            ...
            sb.append("    <input type=checkbox name=\""+getName()+"\" value=\"" + getPropertyValue(prop,"value") + "\"");
...
//		  }
    ...
    public static void main(String[] args) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, JspException {
    	 ...
    	 CheckBoxOptionsTag local=new CheckBoxOptionsTag();
         local.setName("name");
