        ...
        <TR>
            <TD id=leftfrm valign=top >
                <IFRAME
	                ...
	                name=left
	                src=<c:out value="${pageContext.request.contextPath}/menuItem.do?method=getMainMenu"/>
	                frameBorder=0>
                </IFRAME>
            </TD>
            <TD bgColor=#c0c0c0 >
...
<!-- 主页面的显示 注意 iframe 中的name="main"  menuitem中的target必须等于main才可能在主页面上显示出来。-->
            ...
            <!--HEIGHT: 100% 影响到内部框架的上下部分不能移动-->
            <!--style="WIDTH: 100% ;HEIGHT: 100%" Z-INDEX: 1; VISIBILITY: inherit; WIDTH: 100%; HEIGHT: 100%-->
