...
-->
    ...
    <!--=============================================-->
     ...
     <display:column property="user_id" title="用户ID号码" nulls="true" sort="true"/>
     <display:column property="user_name" title="用户姓名" nulls="true" sort="true"/>
     <display:column property="user_password" title="密码" nulls="true" sort="true"/>
     <!--display:column property="userstatus_id" title="用户状态" nulls="true" sort="true"/-->
     ...
     <display:column property="comments"  title="备注"  sort="true"  />
     
      <!-- 没有任何内容的显示，静态文本-->
     <display:column title="备注" media="xxx">##</display:column>   
