...
-->
    ...
    <!--=============================================-->
     ...
     <display:column property="name" title="部门名" nulls="true" sort="true"/>
     <display:column property="company.name" title="公司名" nulls="true" sort="true"/>
    ...
    <display:column title="操作类型" media="html" >
     ...
     <display:caption>部门列表</display:caption>
     <display:footer>
        <tr>
          <td colspan="2"></td>
          <td></td>
