			...
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="images/tbl/m6.gif" align="center" valign="top">
							...
							<html:form action="/userstatus"  
							           focus="userstatus.description"
							           onsubmit="return validateuserstatusForm(this);" >  <!--修改之处-->
							    ...
							    <!--修改之处开始-->
							    <html:hidden property="userstatus.id" />
							    <table class="border">
							        <tr>
							            <td><bean:message key="userstatus.description" />:</td>
							            <td>
							                <!--html:text property="userstatus.description" styleClass="text" /-->
							                <html:select property="userstatus.description">
							                <html:option value=""/>
							                 <html:option value="离线"/>
							                 <html:option value="在线"/>
							                 <html:option value="禁止"/>
							                </html:select>
							            </td>
							            <td><bean:message key="userstatus.comments" />:</td>
							            <td><html:text property="userstatus.comments" styleClass="text"/></td>
							        </tr>
